...
function calcularIVA(valor){
    return resultado = valor + valor*0.21
}

let numero = Number(prompt('Precio sin IVA: '))
console.log('Precio sin IVA: $'+ numero)
console.log('IVA: 21%')
console.log('Precio con IVA: $'+ calcularIVA(numero))